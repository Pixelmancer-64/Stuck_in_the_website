...
class Pendulum {
  ...
  constructor(ctx, width, height) {
    ...
    this.pendulum = {
      length: Math.random() * this.#height * 0.7 + 300,
      width: 0.1,
      origin: {
        x: this.#width / 2,
        y: 0,
  ...
  update() {
    ...
    this.ball.x =
      this.pendulum.length * Math.sin(this.angle) + this.pendulum.origin.x;
    this.ball.y =
      this.pendulum.length * Math.cos(this.angle) + this.pendulum.origin.y;
